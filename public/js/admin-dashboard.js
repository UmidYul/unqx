...
(function () {
  ...
  const THEME_META = {
    ...
    heritage_crest: { label: "Heritage Crest", fill: "#2f4938", border: "#b69a5f", text: "#fff7e8", bg: "#2f4938" },
    ivory_tennis: { label: "Ivory Tennis", fill: "#fbf7e8", border: "#7a8f52", text: "#173222", bg: "#fbf7e8" },
    grand_slam_clay: { label: "Grand Slam Clay", fill: "#b65b31", border: "#f0c37a", text: "#fff4e7", bg: "#b65b31" },
    racing_green: { label: "Racing Green", fill: "#13543a", border: "#d8b35a", text: "#f4f0dd", bg: "#13543a" },
    polo_navy: { label: "Polo Navy", fill: "#243d72", border: "#c8a45b", text: "#f2f6ff", bg: "#243d72" },
    alpine_ski: { label: "Alpine Ski", fill: "#f7fbff", border: "#8fb8d8", text: "#17334b", bg: "#f7fbff" },
    boxing_legend: { label: "Boxing Legend", fill: "#8f1e28", border: "#c8a24c", text: "#fff1e8", bg: "#8f1e28" },
    basketball_court: { label: "Basketball Court", fill: "#f0b05d", border: "#1f2937", text: "#4d260f", bg: "#f0b05d" },
    football_pitch: { label: "Football Pitch", fill: "#38a052", border: "#ffffff", text: "#f4fff5", bg: "#38a052" },
    olympic_gold: { label: "Olympic Gold", fill: "#c7922e", border: "#f5d27a", text: "#fff7df", bg: "#c7922e" },
