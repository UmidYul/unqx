...
(function () {
  ...
  const THEME_META = {
    ...
    ocean_2d: { label: "Океан 2D", fill: "#B8EBFF", border: "#22A8DB", text: "#075985", bg: "linear-gradient(180deg,#E9FBFF 0%,#B8EBFF 46%,#68C8EE 100%)" },
    ...
    uzbekistan_2d: { label: "Узбекистан Diplomatic", fill: "#08121E", border: "#D4AF37", text: "#D4AF37", bg: "radial-gradient(circle at 30% 20%,rgba(0,153,181,.28),transparent 38%),radial-gradient(circle at 80% 78%,rgba(30,181,58,.2),transparent 36%),linear-gradient(145deg,#08121E,#0A192F)" },
