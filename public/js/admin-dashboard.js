...
(function () {
  ...
  const THEME_META = {
    ...
    sakura_blossom: { label: "Цветущая Сакура", fill: "#FDF6F4", border: "#D3A297", text: "#2C1E1A", bg: "#EADBC8" },
    starry_night: { label: "Звездная Ночь", fill: "#0B192C", border: "#F5C71A", text: "#FFF5D1", bg: "#0F1626" },
