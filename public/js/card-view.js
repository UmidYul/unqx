(function initCardViewGlobal() {
  ...
  const THEME_CONFIG = {
    ...
    forest: {
      cardBg: "linear-gradient(170deg, #2a5a35 0%, #386e44 60%, #2e6239 100%)",
      cardBgOverlay: "forest_grain",
      surfaceBg: "#1a4428",
      cardBorder: "1px solid #4a8a5a",
      surfaceBorder: "1px solid #3a7a4a",
      dividerColor: "#5a9a6a",
      nameColor: "#ffffff",
      roleColor: "#b8e8c8",
      mutedColor: "#4a8a5a",
      accentColor: "#f0e8d0",
      emailColor: "#8ac8a8",
      buttonPrimaryBg: "linear-gradient(135deg, #2a6a3a, #3a7a45)",
      buttonPrimaryText: "#ffffff",
      buttonPrimaryBorder: "#6aaa7a",
      buttonSecondaryBg: "transparent",
      buttonSecondaryText: "#b8e8c8",
      buttonSecondaryBorder: "#4a8a5a",
      badgeText: "#f0e8d0",
      badgeBg: "transparent",
      badgeBorder: "transparent",
      topLineGradient: "linear-gradient(90deg, transparent, #ffffff60, transparent)",
      avatarBg: "linear-gradient(135deg, #2e5a38, #3a6a42)",
      avatarText: "#ffffff",
      avatarBorder: "2px solid rgba(255, 255, 255, 0.25)",
      cardBorderRadius: "20px",
      fontFamily: "Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
      nameFontStyle: "italic",
      nameFontWeight: "400",
      roleLetterSpacing: "6px",
      scoreLabelColor: "#b8e8c8",
      scoreValueColor: "#ffffff",
      scoreBarFill: "#f0e8d0",
      scoreBarTrack: "#4a8a5a",
      scorePercentileColor: "#b8e8c8",
      cardShadow: "0 1px 2px rgba(26, 68, 40, 0.35)",
      buttonShineGradient:
        "linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.12) 45%, rgba(255,255,255,0.2) 50%, rgba(255,255,255,0.12) 55%, rgba(255,255,255,0) 100%)",
    },
  };
