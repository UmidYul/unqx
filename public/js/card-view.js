(function initCardViewGlobal() {
  ...
  const THEME_CONFIG = {
    ...
    galaxy: {
      ...
      cardBorder: "1px solid rgba(0, 229, 255, 0.28)",
      surfaceBorder: "1px solid rgba(0, 229, 255, 0.28)",
      ...
      buttonPrimaryBorder: "rgba(0, 229, 255, 0.45)",
      buttonSecondaryBg: "rgba(26, 11, 54, 0.75)",
      buttonSecondaryText: "#f1eaff",
      buttonSecondaryBorder: "rgba(0, 229, 255, 0.32)",
      badgeText: "#061123",
      badgeBg: "linear-gradient(135deg, #00e5ff, #00a3ff)",
      badgeBorder: "1px solid rgba(0, 229, 255, 0.42)",
      ...
      avatarText: "#ffffff",
      avatarBorder: "1px solid rgba(0, 229, 255, 0.38)",
    ...
    sakura_blossom: {
      ...
      nameColor: "#1F1412",
      roleColor: "#B04B4B",
      mutedColor: "rgba(31, 20, 18, 0.66)",
      accentColor: "#FF8397",
      emailColor: "#1F1412",
      buttonPrimaryBg: "linear-gradient(135deg, #FFB5C2 0%, #FF8397 100%)",
      buttonPrimaryText: "#1F1412",
      buttonPrimaryBorder: "rgba(211, 162, 151, 0.72)",
      buttonSecondaryBg: "rgba(253, 250, 242, 0.72)",
      buttonSecondaryText: "#1F1412",
      buttonSecondaryBorder: "rgba(211, 162, 151, 0.58)",
      badgeText: "#1F1412",
      badgeBg: "rgba(255, 181, 194, 0.76)",
      badgeBorder: "1px solid rgba(211, 162, 151, 0.68)",
      topLineGradient: "linear-gradient(90deg, transparent, #D2A298, #FF8397, #D2A298, transparent)",
      avatarBg: "linear-gradient(135deg, #1F1412 0%, #B04B4B 58%, #FFB5C2 100%)",
      avatarText: "#FDFAF2",
      ...
      nameFontWeight: "700",
      roleLetterSpacing: "0.12em",
      scoreLabelColor: "rgba(31, 20, 18, 0.62)",
      scoreValueColor: "#B04B4B",
      scoreBarFill: "linear-gradient(90deg, #D2A298, #FF8397)",
      scoreBarTrack: "rgba(211, 162, 151, 0.18)",
      scorePercentileColor: "#B04B4B",
    ...
    starry_night: {
      ...
      nameColor: "#FFF4D0",
      roleColor: "#ECC128",
      mutedColor: "rgba(255, 244, 208, 0.68)",
      accentColor: "#FFD500",
      emailColor: "#FFF4D0",
      buttonPrimaryBg: "linear-gradient(135deg, #ECC128 0%, #FFD500 100%)",
      buttonPrimaryText: "#0C1A30",
      buttonPrimaryBorder: "rgba(245, 199, 26, 0.62)",
      buttonSecondaryBg: "rgba(11, 25, 44, 0.72)",
      buttonSecondaryText: "#FFF4D0",
      buttonSecondaryBorder: "rgba(245, 199, 26, 0.42)",
      badgeText: "#0C1A30",
      badgeBg: "#FFD500",
      badgeBorder: "1px solid rgba(255, 244, 208, 0.48)",
      topLineGradient: "linear-gradient(90deg, transparent, #213D68, #ECC128, #FFD500, transparent)",
      avatarBg: "radial-gradient(circle at 38% 26%, #FFF4D0, #ECC128 34%, #0C1A30 100%)",
      avatarText: "#0C1A30",
      ...
      nameFontWeight: "800",
      roleLetterSpacing: "0.12em",
      scoreLabelColor: "rgba(255, 244, 208, 0.66)",
      scoreValueColor: "#FFD500",
      scoreBarFill: "linear-gradient(90deg, #213D68, #ECC128, #FFD500)",
      scoreBarTrack: "rgba(255, 244, 208, 0.12)",
      scorePercentileColor: "#ECC128",
  ...
  function renderCardView(input, options = {}) {
    ...
    const styleTokens = [
      ...
      `--theme-card-overlay-opacity:${esc(Number(theme.tokens.cardBgOverlayOpacity || 14) / 100 || 0.14)}`,
      `--theme-surface-radius:${esc(theme.tokens.surfaceBorderRadius || "16px")}`,
      `--theme-button-radius:${esc(theme.tokens.buttonBorderRadius || "9999px")}`,
      `--theme-avatar-radius:${esc(theme.tokens.avatarBorderRadius || "9999px")}`,
      `--theme-badge-radius:${esc(theme.tokens.badgeBorderRadius || "9999px")}`,
      `--theme-font-family:${esc(theme.tokens.fontFamily)}`,
      `--theme-name-font-size:${esc(theme.tokens.nameFontSize || "35px")}`,
      `--theme-name-font-style:${esc(theme.tokens.nameFontStyle)}`,
      `--theme-name-font-weight:${esc(theme.tokens.nameFontWeight)}`,
      `--theme-name-letter-spacing:${esc(theme.tokens.nameLetterSpacing || "-0.03em")}`,
      `--theme-name-text-transform:${esc(theme.tokens.nameTextTransform || "none")}`,
      `--theme-role-font-size:${esc(theme.tokens.roleFontSize || "11px")}`,
      `--theme-role-font-weight:${esc(theme.tokens.roleFontWeight || "500")}`,
      `--theme-role-letter-spacing:${esc(theme.tokens.roleLetterSpacing)}`,
      `--theme-role-text-transform:${esc(theme.tokens.roleTextTransform || "none")}`,
      `--theme-bio-font-size:${esc(theme.tokens.bioFontSize || "13px")}`,
      `--theme-bio-font-weight:${esc(theme.tokens.bioFontWeight || "500")}`,
      `--theme-bio-letter-spacing:${esc(theme.tokens.bioLetterSpacing || "0")}`,
      `--theme-bio-text-transform:${esc(theme.tokens.bioTextTransform || "none")}`,
      `--theme-email-font-size:${esc(theme.tokens.emailFontSize || "20px")}`,
