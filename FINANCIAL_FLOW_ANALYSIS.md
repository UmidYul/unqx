...
- [ ] Добавить cron задачу освобождения expired slugs
- [ ] Ограничить активные заказы на пользователя (макс 3)
- [ ] Добавить кнопку "Отменить заказ" в профиле
- [ ] Связать Purchase.slugRequestId через FK
- [ ] Добавить audit log изменений цен
