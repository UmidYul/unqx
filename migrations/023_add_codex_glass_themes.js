      ...
      BEGIN
        IF EXISTS (SELECT 1 FROM pg_type WHERE typname = 'CardTheme') THEN
          IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'CardTheme_new') THEN
            EXECUTE 'CREATE TYPE "CardTheme_new" AS ENUM (''default_dark'', ''arctic'', ''linen'', ''marble'', ''forest'', ''sage_luxe'', ''midnight_obsidian'', ''golden_noir'', ''aurora_codex'', ''nebula_glass'')';
          END IF;
          ...
          IF EXISTS (
            ...
            EXECUTE 'ALTER TABLE public.cards ALTER COLUMN theme TYPE "CardTheme_new" USING (
              CASE
                WHEN theme::text = ''royal_ivory'' THEN ''sage_luxe''::"CardTheme_new"
                WHEN theme::text IN (''default_dark'', ''arctic'', ''linen'', ''marble'', ''forest'', ''sage_luxe'', ''midnight_obsidian'', ''golden_noir'', ''aurora_codex'', ''nebula_glass'')
                  THEN theme::text::"CardTheme_new"
                ELSE ''default_dark''::"CardTheme_new"
              END
            )';
          ...
          IF EXISTS (
            ...
            EXECUTE 'ALTER TABLE public.profile_cards ALTER COLUMN theme TYPE "CardTheme_new" USING (
              CASE
                WHEN theme::text = ''royal_ivory'' THEN ''sage_luxe''::"CardTheme_new"
                WHEN theme::text IN (''default_dark'', ''arctic'', ''linen'', ''marble'', ''forest'', ''sage_luxe'', ''midnight_obsidian'', ''golden_noir'', ''aurora_codex'', ''nebula_glass'')
                  THEN theme::text::"CardTheme_new"
          ...
          IF EXISTS (
            ...
            EXECUTE 'ALTER TABLE public.order_requests ALTER COLUMN theme TYPE "CardTheme_new" USING (
              CASE
