...
const REQUIRED_ENUMS = {
  ...
  cardtheme: ["default_dark", "arctic", "linen", "marble", "forest", "sage_luxe", "midnight_obsidian", "golden_noir", "aurora_codex", "nebula_glass", "velours", "graffiti_neon", "heritage_crest", "ivory_tennis", "grand_slam_clay", "racing_green", "polo_navy", "alpine_ski", "boxing_legend", "basketball_court", "football_pitch", "olympic_gold", "anime_blush", "cheetah_spots", "serpent_scale", "color_red", "color_orange", "color_yellow", "color_green", "color_teal", "color_blue", "color_purple", "color_pink"],
