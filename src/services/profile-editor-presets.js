...
const AVATAR_FRAMES = [
  ...
  { id: "symbiote", label: "Живой Симбиот", description: "Venom tendrils dual glow", premiumRequired: true },
  { id: "lightning", label: "Искрящаяся Молния", description: "Electric arc border", premiumRequired: true },
  { id: "zen_bamboo", label: "Дзен-Бамбук", description: "Матовая восточная кайма", premiumRequired: true },
  { id: "sakura_aura", label: "Лепесток Сакуры", description: "Silky pink aura", premiumRequired: true },
  { id: "gogh_strokes", label: "Мазки Импрессиониста", description: "Blue and gold paint strokes", premiumRequired: true },
  { id: "lunar_gold", label: "Золотая Корона Луны", description: "Warm lunar metal glow", premiumRequired: true },
  { id: "chakra", label: "Кольцо Чакры", description: "Rasengan energy ring", premiumRequired: true },
