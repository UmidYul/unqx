...
const DEFAULT_SETTINGS = [
  ...
  { key: "pet_kitten_price", group: "pricing", type: "number", label: "Цена питомца: Коала", value: 2_000_000 },
  { key: "pet_puppy_price", group: "pricing", type: "number", label: "Цена питомца: Котик", value: 5_000_000 },
  { key: "pet_snake_price", group: "pricing", type: "number", label: "Цена питомца: Леопард", value: 7_000_000 },
  ...
  { key: "homepage_promo_banner_visible", group: "homepage", type: "boolean", label: "Промо-баннер", value: true },
  { key: "homepage_promo_banner_image_url", group: "homepage", type: "text", label: "Картинка промо-баннера", value: "/images/card.png" },
  { key: "homepage_promo_banner_target_url", group: "homepage", type: "text", label: "Ссылка промо-баннера", value: "#calculator" },
  { key: "homepage_promo_banner_alt", group: "homepage", type: "text", label: "Alt промо-баннера", value: "UNQX Promo Banner" },
